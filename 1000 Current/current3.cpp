...
public: 
	...
	void printHeap() {
		for(int i=1; i<=index; i++) //index print krne se inserted elements aayenge  
        {                           // capacity se sare aa jayenge so garbage values 
			cout << arr[i] << " ";  // inside array also printed and deleted nodes also get printed
		}
		cout << endl;
        /*
...
int main()  {
	...
	buildHeap(arr, n);//implementing so use array  // for visualiszation use tree
